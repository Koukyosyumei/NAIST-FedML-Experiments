...
python3 gpu_mapping_yaml_generator.py --client_num_per_round $client_num --worker_num_pergpu $worker_num_pergpu --gpupernode $gpupernode
...
mpirun -np ${np} -npernode ${npernode} python3 ${py_file} \\
  ...
  --gpu_mapping_key mapping_config_client_num_per_round_${client_num}_worker_num_pergpu_${worker_num_pergpu}_gpupernode_${gpupernode} \\
  --model ${model} \\
  --dataset ${dataset} \\
  --data_dir ${data_dir} \\
